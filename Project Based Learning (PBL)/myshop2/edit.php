            ...
            <div class="row mx-auto w-50">
                <form action="http://localhost:85/myshop2/update.php" method="post">
                    <div class="input-group mb-3">
                        ...
                        <input name="id" value="<?php echo $row['id']; ?>" type="number" class="form-control text-center"
                            readonly>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Student ID</span>
                        <input name="stdid" value="<?php echo $row['student_id']; ?>" type="text"
                            class="form-control text-center">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Student Name</span>
                        <input name="stdname" value="<?php echo $row['student_name']; ?>" type="text"
                            class="form-control text-center">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Student Department</span>
                        <input name="stddept" value="<?php echo $row['student_department']; ?>" type="text"
                            class="form-control text-center">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Mark 1</span>
                        <input name="stdmk1" value="<?php echo $row['student_mark1']; ?>" type="number"
                            class="form-control text-center">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Mark 2</span>
                        <input name="stdmk2" value="<?php echo $row['student_mark2']; ?>" type="number"
                            class="form-control text-center">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Mark 3</span>
                        <input name="stdmk3" value="<?php echo $row['student_mark3']; ?>" type="number"
                            class="form-control text-center">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Percentage</span>
                        <input name="stdperc" value="<?php echo $row['student_percent']; ?>%" type="text"
                            class="form-control text-center" readonly>
                    </div>
                    <button type="submit"
                        onclick="return confirm('Are you sure you want to update the information for <?php echo $row['student_name']; ?>?')"
